...
class Generator:
    ...
    def _setup_collection_skeleton(self, output_dir: str):
        ...
        readme_content = (
            ...
            "## Usage\n\n"
            "Reference modules using their Fully Qualified Collection Name (FQCN), for example: `waldur.cloud.waldur_project`.\n"
        )
    ...
    def generate(self, output_dir: str):
        ...
        for module_key, raw_config in self.config_data.get("modules", {}).items():
            ...
            try:
                ...
                rendered_template = GENERIC_MODULE_TEMPLATE.format(**context_dict)
