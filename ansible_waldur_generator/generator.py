...
class Generator:
    ...
    def _setup_collection_skeleton(self, output_dir: str, module_names: list[str]):
        ...
        galaxy_data = {
            ...
            # The collection links against ansible-core (GPL-3.0-or-later), so it
            # is distributed under the same licence. The LICENSE file is copied
            # alongside from templates/LICENSE.gpl-3.0.
        ...
        # Ship the full GPL-3.0 text with the collection.
        license_src = os.path.join(
            os.path.dirname(__file__), "templates", "LICENSE.gpl-3.0"
        )
        shutil.copy(license_src, os.path.join(collection_root, "LICENSE"))
        ...
        readme_content = (
            ...
            "## License\n\n"
            f"Copyright (C) {datetime.date.today().year} OpenNode OÜ\n\n"
